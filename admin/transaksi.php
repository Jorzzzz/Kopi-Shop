            ...
            <?php
                ...
                while($dt_histori=mysqli_fetch_array($qry_histori)){ 
                    ...
                    if(mysqli_num_rows($qry_cek_bayar)>0){ 
                        ...
                        $button="<a class='btn' href='struk.php?id_transaksi=".$dt_histori['id_transaksi']."'><i class='las la-receipt'></i>Lihat Struk</a>";; 
                    } else {
                        $status_transaksi="<label class='belum'>BELUM BAYAR</label>";
                        $button="<a class='btn' href='bayar.php?id_transaksi=".$dt_histori['id_transaksi']."' onclick='return confirm(\"Anda yakin sudah bayar ?\")'><i class='las la-cash-register'></i>Sudah Bayar</a>";
                    }
            ?>
            <tr>
