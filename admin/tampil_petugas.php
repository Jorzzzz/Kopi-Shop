    ...
    <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="ubah_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" class="ubah">UBAH<i class="las la-user-edit"></i></a> |
                    <a href="hapus_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="hapus">HAPUS<i class="las la-ban"></i></a>
                </td>                
            </tr>
            <?php } ?>
        </table>
