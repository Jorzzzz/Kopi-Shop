    ...
    <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="ubah_pelanggan.php?id_pelanggan=<?=$data_pelanggan['id_pelanggan']?>" class="ubah"><i class="las la-user-edit">UBAH</i></a> |
                    <a href="hapus_pelanggan.php?id_pelanggan=<?=$data_pelanggan['id_pelanggan']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="hapus">HAPUS<i class="las la-ban"></i></a>
                </td>                
            </tr>
            <?php } ?>
        </table>
